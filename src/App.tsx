...
function App() {
  ...
  // bulacagız ve objeye ekliyecegiz (performans için memo kullandık)
  ...
  const updateNote = (id: string, { tags, ...data }: NoteData) => {
    // bir note alacagız
    // notu state'de tutuğumuz dizideki halini bulacagız
    // dizideki eski versiyonu kaldıracagız
    // yerine aldığımız yeni notu koyacagız
